...
function MenHero() {
  return (
    <section className="relative overflow-hidden bg-linear-to-br from-brand-purple-pale via-white to-brand-pink-pale">
      <div className="grid lg:grid-cols-2 lg:items-stretch lg:min-h-[580px]">
        ...
        <div className="relative h-[260px] w-full lg:order-2 lg:h-full lg:min-h-[580px]">
          <div className="absolute inset-0 bg-linear-to-br from-brand-purple-pale via-brand-pink-pale to-white" />
          <Image
            src="/images/oshikatsu.webp"
            alt="推し活グッズに囲まれた部屋でスマホを使う男性のイラスト"
            fill
            priority
            quality={90}
          ...
          <Container wide className="lg:mx-0 lg:max-w-none lg:pr-0 lg:pl-10 xl:pl-16">
            <div className="mx-auto max-w-md text-center lg:mx-0 lg:max-w-lg lg:text-left">
              ...
              <h1 className="font-heading text-[26px] leading-[1.35] font-black text-brand-ink sm:text-[32px] lg:text-[40px]">
                推しに、
                <br />
                <span className="text-brand-pink-deep">かっこよくなって</span>
                <br />
                会いにいく。
              </h1>
...
function MenWorries() {
  return (
    <section className="bg-linear-to-br from-brand-purple-pale via-white to-brand-pink-pale py-10 lg:py-16">
      <Container>
        ...
        <ul className="mx-auto mt-8 flex max-w-xl flex-col gap-3">
          {worries.map((worry) => (
            <li
              key={worry}
              className="flex items-center gap-3 rounded-2xl border border-brand-purple-light bg-white/80 px-5 py-4 text-[14.5px] font-medium leading-relaxed text-brand-ink shadow-sm"
            >
              <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-brand-purple-pale text-brand-purple text-xs font-black">
                •
              </span>
              {worry}
            </li>
      ...
      <Container>
        <div className="flex flex-col items-center gap-10 lg:flex-row lg:items-center lg:gap-16">
          ...
          <div className="w-full lg:order-2 lg:flex-1">
            <div className="relative mx-auto aspect-[4/3] w-full max-w-[480px] overflow-hidden rounded-3xl bg-linear-to-br from-brand-purple-pale via-white to-brand-pink-pale shadow-md lg:max-w-none">
              <Image
                src="/images/home.webp"
                alt="自宅でスマホを使って相談する男性のイラスト"
                fill
                quality={90}
                sizes="(min-width: 1024px) 50vw, 100vw"
          ...
          <div className="w-full lg:order-1 lg:flex-1">
            ...
            <h2 className="mt-2 text-center font-heading text-[26px] leading-[1.35] font-black text-brand-ink sm:text-[30px] lg:text-left lg:text-[36px]">
              <span className="text-brand-pink-deep">"推し活前の</span>
              <br />
              <span className="text-brand-pink-deep">自分磨き"</span>
              という選択肢
            </h2>

            <p className="mt-4 text-center text-[14px] leading-relaxed text-brand-ink/70 lg:text-left">
...
function MenBenefits() {
  return (
    <section className="bg-linear-to-br from-brand-purple-pale/40 via-white to-brand-pink-pale py-10 lg:py-16">
      <Container>
        <SectionHeading
          eyebrow="FEATURES"
          title={
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          {benefits.map(({ icon: Icon, title, desc }) => (
            <div
              key={title}
              className="flex items-start gap-4 rounded-2xl border border-brand-purple-light bg-white px-5 py-5 shadow-sm"
            >
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-brand-purple-pale shadow-sm">
                <Icon className="h-4.5 w-4.5 text-brand-purple" />
              </div>
              <div>
                <p className="text-[14px] font-bold text-brand-ink">{title}</p>
...
const medicineCategories = [
  ...
  },
  {
    ...
    items: ["美容内服", "ビタミン補給", "睡眠改善薬", "その他内服薬・サプリメント"],
...
const steps = [
  {
    ...
    desc: "LINEを友だち追加して、30秒アンケートに回答するだけ。対象の方へクーポンをご案内します。",
  },
  {
    step: "02",
    title: "問診票の入力",
    ...
    <section className="bg-linear-to-br from-brand-purple-pale via-white to-brand-pink-pale py-10 lg:py-16">
      <Container>
        <div className="flex flex-col items-center gap-8 lg:flex-row lg:items-stretch lg:gap-10">
          {/* 画像 — PC: 右, SP: 上 */}
          <div className="w-full lg:order-2 lg:w-[55%] lg:shrink-0">
            <div className="relative mx-auto aspect-[4/3] w-full max-w-[520px] overflow-hidden rounded-3xl bg-linear-to-br from-brand-purple-pale via-white to-brand-pink-pale shadow-md lg:aspect-auto lg:h-full lg:min-h-[380px] lg:max-w-none">
              <Image
                src="/images/cta.webp"
                alt="スマホでシェアクリを使う男性のイラスト"
                fill
                quality={90}
          ...
          {/* テキスト — PC: 左, SP: 下 */}
          <div className="w-full lg:order-1 lg:w-[45%] lg:shrink-0 lg:flex lg:flex-col lg:justify-center">
            <h2 className="text-center font-heading text-[26px] leading-[1.4] font-black text-brand-ink sm:text-[30px] lg:text-left lg:text-[34px]">
              次の現場に向けて、
              <br />
              <span className="text-brand-pink-deep">自分を少し</span>
              <br />
              整えてみませんか？
            </h2>
            <p className="mt-5 text-center text-[14px] leading-relaxed text-brand-ink/70 lg:text-left">
              髪や体型の悩みは、ひとりで抱え込まなくても大丈夫です。
            </p>
            <p className="mt-3 text-center text-[14px] leading-relaxed text-brand-ink/70 lg:text-left">
              まずは30秒アンケートから、
              <br />
              相談できる内容を確認してみてください。
            </p>
            <div className="mt-8 lg:max-w-sm">
              ...
              <p className="mt-2.5 text-center text-[12.5px] leading-relaxed text-brand-ink/60 lg:text-left">
                アンケート回答後、対象の方にLINEでクーポンをご案内します。
              </p>
